...
namespace RenewalTML.Shared.Exstention
{
    #line hidden
    using System;
...
#line hidden
#nullable disable
    public partial class ToLink___Копировать : Microsoft.AspNetCore.Components.ComponentBase
    {
...
#nullable restore
#line 6 "C:\Users\Fearp\source\repos\RenewalTML\RenewalTML\Shared\Exstention\ToLink - Копировать.razor"
    ...
    private async Task Navigate()
    {
        ...
        {
            if (UriHelper.ToBaseRelativePath(UriHelper.Uri) != Url)
            {
                await JS.InvokeVoidAsync("LoadingRepositry.startLoading");

                //UriHelper.NavigateTo(Url)

                await off_loyoutRender.InvokeAsync();

                //await JS.InvokeVoidAsync("Blazor._internal.navigationManager.navigateTo", Url, false, false);
